...
class Travel_Booking_Customizer_Notice {
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'travel-booking-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', array(), TRAVEL_BOOKING_PRO_THEME_VERSION );
		...
		wp_localize_script(
			'travel-booking-customizer-notice', 'customizer_notice_data', array(
				...
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'travel-booking-pro' ),
			)
		);
