...
if ( ! class_exists( 'Travel_Booking_Pro_MultiCheck_Control' ) ) {

	/**
	 * Adds a multicheck control.
	 */
	class Travel_Booking_Pro_MultiCheck_Control extends Wp_Customize_Control {

		public $type = 'travel-booking-pro-multicheck';
