 ...
 */
class Travel_Booking_Pro_Sortable extends WP_Customize_Control {

	public $type = 'travel-sortable';
		...
		<label class='travel-sortable'>
			...
			<ul class="sortable">
				<# _.each( data.value, function( choiceID ) { #>
					<li {{{ data.inputAttrs }}} class='travel-sortable-item' data-value='{{ choiceID }}'>
				...
				<# _.each( data.choices, function( choiceLabel, choiceID ) { #>
					<# if ( -1 === data.value.indexOf( choiceID ) ) { #>
						<li {{{ data.inputAttrs }}} class='travel-sortable-item invisible' data-value='{{ choiceID }}'>
							<i class='dashicons dashicons-menu'></i>
							<i class="dashicons dashicons-visibility visibility"></i>
							{{{ data.choices[ choiceID ] }}}
						</li>
